...
select a.assessmentareaname, b. assessmentareaname from assessmentarea a
join assessmentarea b on b.assessmentareaid = a.parentassessmentareaid

update AssessmentArea  set ParentAssessmentAreaId = null;
...
Select * from assess_new.Customer
