<!--QUESTIONS START HERE -->	
    <div style="background-color: white" class="grid_10" >
		...
		<#list feedbackQuestions.getCompetencies() as c>
			
				<h1>${c.getCompetencyName()}</h1>
				<hr>
				
				<div >
				<#list c.getSubCompetencies() as sc>
				
					<h2>${sc.getSubCompetencyName()}</h2>
					<hr>	
					<div>
					<#list sc.getQuestionAnswers() as qa>
				  		<hr>
					   <tr>
